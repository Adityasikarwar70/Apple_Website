...
import ExploreIphone from "./smallComponents/ExploreIphone";
...
const Compatible = () => {
  ...
  return (
    <section className="  sm:py-32 py-20 sm:px-10  flex flex-col gap-[10vw] items-center justify-center bg-white ">
        ...
        <div>
            <img id="macImg" className=" relative md:-left-[15vw] md:-top-[10vh]" src={MAc} alt="" />
        </div>
